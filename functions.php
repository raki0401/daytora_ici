...
function my_script_init()
{
  ...
  wp_enqueue_style('me', get_template_directory_uri() . '/css/reset.css', array(), '1.0.0', 'all');
  wp_enqueue_style('mi', get_template_directory_uri() . '/css/animate.css', array(), '1.0.0', 'all');
...
// add_image_size( 'single', 250,140, true );
